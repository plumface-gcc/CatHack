...
namespace CatHack.modules
{
    class ChampPosition
    {
        ...
        private static float attackRange = ActivePlayerData.ChampionStats.GetAttackRange();

        public static Point GetEnemyPosition()
        {
            if (attackRange >= 500 && attackRange < 650)
            {
                Rectangle FOV = new Rectangle(450, 120, 910, 750); // 550
            ...
            {
                Rectangle FOV = new Rectangle(385, 55, 1100, 875); // 650
            ...
            {
                Rectangle FOV = new Rectangle(300, 50, 1300, 900); // 850
